...
public interface ICSSListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ICSSParser#expression2}.
	 * @param ctx the parse tree
	 */
	void enterExpression2(ICSSParser.Expression2Context ctx);
	/**
	 * Exit a parse tree produced by {@link ICSSParser#expression2}.
	 * @param ctx the parse tree
	 */
	void exitExpression2(ICSSParser.Expression2Context ctx);
	/**
	 * Enter a parse tree produced by the {@code none}
	 * labeled alternative in {@link ICSSParser#operation}.
	 * @param ctx the parse tree
	 */
	void enterNone(ICSSParser.NoneContext ctx);
	/**
	 * Exit a parse tree produced by the {@code none}
	 * labeled alternative in {@link ICSSParser#operation}.
	 * @param ctx the parse tree
	 */
	void exitNone(ICSSParser.NoneContext ctx);
	/**
